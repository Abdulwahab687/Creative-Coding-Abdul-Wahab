let letters = [];
let message = "Creativity Unleashed";
let particles = [];
...
function draw() {
  ...
  let r = 50 + 50 * sin(frameCount * 0.01);
  let g = 30 + 80 * sin(frameCount * 0.008 + PI / 2);
  let b = 60 + 70 * sin(frameCount * 0.009 + PI);
  background(r, g, b);
